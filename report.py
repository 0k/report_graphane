...
class GraphaneParser(xml_report.XmlParser):
    ...
    ## Override the default additional header from the ReportXml
    ## report_xml.xml_full_dump_additional_headers
    def _get_additional_data(self, cr, uid, ids, data, report_graphane, context=None):
        return report_graphane.graphane_header
    ...
    def create_single_pdf(self, cr, uid, ids, data, report_xml, context=None):
        ...
        server = GraphaneXMLRPC(report_xml.graphane_xmlrpc_url)
